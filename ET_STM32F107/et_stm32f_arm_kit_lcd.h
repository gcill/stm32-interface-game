...
#define LCD_CS_GPIO_CLK        RCC_APB2ENR_IOPCEN  

#define LCD_BL_GPIO_PIN        GPIO_PIN_7                  // PD7 = BL GLCD
#define LCD_BL_GPIO_PORT       GPIOD                       
#define LCD_BL_GPIO_CLK        RCC_APB2ENR_IOPDEN 
...
#define LCD_SPI_GPIO_CLK       RCC_APB2ENR_IOPCEN  
#define LCD_SPI			       		 SPI3
#define LCD_SPI_CLK		       	 RCC_APB1RSTR_SPI3RST
...
// PE6(CS#)	 -->
// PE7(SCK)	 --> 
#define TCS_GPIO_CLK           RCC_APB2ENR_IOPEEN  
